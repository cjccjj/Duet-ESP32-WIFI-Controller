...
class Adafruit_SH1106_ESP32 : public Adafruit_GFX {
 public:
  Adafruit_SH1106_ESP32(int8_t SID, int8_t SCLK, int8_t DC, int8_t RST, int8_t CS);
  Adafruit_SH1106_ESP32(int8_t DC, int8_t RST, int8_t CS);

  Adafruit_SH1106_ESP32(uint8_t RST);
  Adafruit_SH1106_ESP32(int8_t SDA=-1, int8_t SCL=-1);
